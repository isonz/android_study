...
public class MainActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        */
        ...
        String[] names = new String[]{"A神", "基神", "曹神"};
        String[] says = new String[]{"无形被黑，最为致命", "大神好厉害~", "我将带头~"};
        int[] imgIds = new int[]{R.mipmap.touxiang1, R.mipmap.touxiang2, R.mipmap.touxiang3};
